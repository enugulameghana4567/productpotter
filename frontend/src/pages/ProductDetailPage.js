...
const DEFAULT_PRODUCTS = {
  'default4': { _id: 'default4', name: 'Faith Clipboard', bibleVerse: 'Matthew 19:26', inspirationalSentence: 'With God, nothing is impossible — trust the journey.', description: 'A beautifully crafted clipboard with elegant floral design and the inspiring verse — "With God all things are possible." Perfect for your desk or as a meaningful gift to someone you love.', colorDescription: 'Warm grey background with white floral outlines and peach botanicals.', designDescription: 'Watercolor botanical art with delicate flowers, leaves, and gold accents.', themeDescription: 'Faith and hope — a reminder that God makes all things possible.', image: '/images/product1.jpeg', imageData: '', images: [], imagesData: [], video: '', videoData: '' },
  'default3': { _id: 'default3', name: 'Rejoice Clipboard', bibleVerse: 'Philippians 4:4', inspirationalSentence: "Rejoice always — God's joy is your strength every single day.", description: 'Elegant dark green clipboard with silver botanical art and the joyful verse — "Rejoice in the Lord always." A stunning piece for any faith-filled home or office space.', colorDescription: 'Deep forest green with silver-toned lettering and botanical illustrations.', designDescription: 'Watercolor eucalyptus and leaf clusters with golden accent details.', themeDescription: 'Joy in the Lord — a daily reminder to rejoice in every circumstance.', image: '/images/product2.jpeg', imageData: '', images: [], imagesData: [], video: '', videoData: '' },
  'default2': { _id: 'default2', name: 'Strength Clipboard', bibleVerse: 'Philippians 4:13', inspirationalSentence: 'You are stronger than you know — Christ is your strength.', description: 'A serene light blue clipboard adorned with a delicate wildflower wreath and the empowering verse — "I can do all things through Christ who strengtheneth me." Uplifting for every day.', colorDescription: 'Soft sky blue background with multi-colored wildflower wreath in pastels.', designDescription: 'Botanical wildflower wreath with daisies, lavender, and meadow flowers.', themeDescription: 'Strength in Christ — a reminder that you can overcome anything through faith.', image: '/images/product3.jpeg', imageData: '', images: [], imagesData: [], video: '', videoData: '' },
  'default1': { _id: 'default1', name: 'Wisdom Clipboard', bibleVerse: 'Proverbs 1:7', inspirationalSentence: 'True wisdom begins when we place God first in everything.', description: 'Warm beige clipboard with golden botanical accents and the wisdom scripture — "The fear of the LORD is the beginning of knowledge." A timeless keepsake for any believer.', colorDescription: 'Warm beige/linen background with sage green and golden botanical accents.', designDescription: 'Elegant leafy botanical garlands with gold-tipped branches and earthy tones.', themeDescription: 'Wisdom and knowledge — a beautiful reminder to seek God above all things.', image: '/images/product4.jpeg', imageData: '', images: [], imagesData: [], video: '', videoData: '' }
};
